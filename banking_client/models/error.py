...
class Error(object):
    ...
    def __init__(self, id=None, message=None, url=None):  # noqa: E501
    ...
    def message(self):
        ...
        description of error raised, formatted to be presentable to the end user  # noqa: E501
    ...
    def url(self):
        ...
        reference url with more information about the error  # noqa: E501
