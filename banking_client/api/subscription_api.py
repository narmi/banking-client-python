...
class SubscriptionApi(object):
    ...
    def create(self, body, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param Subscription body: Subscription attributes to create object (required)
    ...
    def create_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.create_with_http_info(body, async=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'authorization', 'date', 'signature', 'x_request_id']  # noqa: E501
    ...
    def destroy(self, subscription_id, **kwargs):  # noqa: E501
        """Delete subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.destroy(subscription_id, async=True)
        >>> result = thread.get()

        :param async bool
        :param str subscription_id: The id of the subscription to be operated on (required)
        :param str authorization:
        :param str date:
        :param str signature:
        :param str x_request_id:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.destroy_with_http_info(subscription_id, **kwargs)  # noqa: E501
        else:
            (data) = self.destroy_with_http_info(subscription_id, **kwargs)  # noqa: E501
            return data

    def destroy_with_http_info(self, subscription_id, **kwargs):  # noqa: E501
        """Delete subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.destroy_with_http_info(subscription_id, async=True)
        >>> result = thread.get()
        ...
        all_params = ['subscription_id', 'authorization', 'date', 'signature', 'x_request_id']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('subscription_id' not in params or
            ...
            raise ValueError("Missing the required parameter `subscription_id` when calling `destroy`")  # noqa: E501
    ...
    def get(self, subscription_id, **kwargs):  # noqa: E501
        """Get subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get(subscription_id, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_with_http_info(subscription_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_with_http_info(subscription_id, **kwargs)  # noqa: E501
            return data

    def get_with_http_info(self, subscription_id, **kwargs):  # noqa: E501
        """Get subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_with_http_info(subscription_id, async=True)
        >>> result = thread.get()
    ...
    def update(self, subscription_id, body, **kwargs):  # noqa: E501
        """Update subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update(subscription_id, body, async=True)
        >>> result = thread.get()

        :param async bool
        :param str subscription_id: The id of the subscription to be operated on (required)
        :param Subscription body: Subscription attributes to update object (required)
        :param str authorization:
        :param str date:
        :param str signature:
        :param str x_request_id:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_with_http_info(subscription_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_with_http_info(subscription_id, body, **kwargs)  # noqa: E501
            return data

    def update_with_http_info(self, subscription_id, body, **kwargs):  # noqa: E501
        """Update subscription  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_with_http_info(subscription_id, body, async=True)
        >>> result = thread.get()
        ...
        all_params = ['subscription_id', 'body', 'authorization', 'date', 'signature', 'x_request_id']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('subscription_id' not in params or
                params['subscription_id'] is None):
            raise ValueError("Missing the required parameter `subscription_id` when calling `update`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
