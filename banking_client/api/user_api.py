...
class UserApi(object):
    ...
    def get(self, user_id, **kwargs):  # noqa: E501
        """Get user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get(user_id, async=True)
        >>> result = thread.get()

        :param async bool
        :param str user_id: The id of the user to be operated on (required)
        ...
        if kwargs.get('async'):
            return self.get_with_http_info(user_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_with_http_info(user_id, **kwargs)  # noqa: E501
            return data

    def get_with_http_info(self, user_id, **kwargs):  # noqa: E501
        """Get user  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_with_http_info(user_id, async=True)
        >>> result = thread.get()
        ...
        all_params = ['user_id', 'authorization', 'date', 'signature', 'x_request_id']  # noqa: E501
        ...
        if ('user_id' not in params or
            ...
            raise ValueError("Missing the required parameter `user_id` when calling `get`")  # noqa: E501
