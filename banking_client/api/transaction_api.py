...
class TransactionApi(object):
    ...
    def get(self, transaction_id, **kwargs):  # noqa: E501
        """Get transaction  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get(transaction_id, async=True)
        >>> result = thread.get()

        :param async bool
        :param str transaction_id: The id of the transaction to be operated on (required)
        ...
        if kwargs.get('async'):
            return self.get_with_http_info(transaction_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_with_http_info(transaction_id, **kwargs)  # noqa: E501
            return data

    def get_with_http_info(self, transaction_id, **kwargs):  # noqa: E501
        """Get transaction  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_with_http_info(transaction_id, async=True)
        >>> result = thread.get()
        ...
        all_params = ['transaction_id', 'authorization', 'date', 'signature', 'x_request_id']  # noqa: E501
        ...
        if ('transaction_id' not in params or
            ...
            raise ValueError("Missing the required parameter `transaction_id` when calling `get`")  # noqa: E501
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        :param str signature:
        :param str x_request_id:
        :param str before: A cursor to paginate large (time sorted) collections. Use to return results sorted before (greater than) the given ID. 
        :param str after: A cursor to paginate large (time sorted) collections. Use to return results sorted after (less than) the given ID. 
        :param str filter: Indicate which type of transactions to return. Can be one of:   * `unsettled`: transactions without a `settled_at` time 
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['page', 'per_page', 'authorization', 'date', 'signature', 'x_request_id', 'before', 'after', 'filter']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_transactions(self, account_id, **kwargs):  # noqa: E501
        """List transactions for an account  # noqa: E501
        ...
        :param async bool
        :param str account_id: The id of the account for which to retrieve transactions (note that this identifies an account at the suffix level) (required)
        :param int page:
        :param int per_page:
        :param str authorization:
        :param str date:
    ...
    def list_transactions_with_http_info(self, account_id, **kwargs):  # noqa: E501
        ...
        all_params = ['account_id', 'page', 'per_page', 'authorization', 'date', 'signature', 'x_request_id', 'before', 'after']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update(self, transaction_id, body, **kwargs):  # noqa: E501
        """Update transaction  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update(transaction_id, body, async=True)
        >>> result = thread.get()

        :param async bool
        :param str transaction_id: The id of the transaction to be operated on (required)
        :param Transaction body: Transaction attributes to be updated (required)
        :param str authorization:
        :param str date:
        :param str signature:
        :param str x_request_id:
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.update_with_http_info(transaction_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_with_http_info(transaction_id, body, **kwargs)  # noqa: E501
            return data

    def update_with_http_info(self, transaction_id, body, **kwargs):  # noqa: E501
        """Update transaction  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.update_with_http_info(transaction_id, body, async=True)
        >>> result = thread.get()
        ...
        all_params = ['transaction_id', 'body', 'authorization', 'date', 'signature', 'x_request_id']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('transaction_id' not in params or
                params['transaction_id'] is None):
            raise ValueError("Missing the required parameter `transaction_id` when calling `update`")  # noqa: E501
