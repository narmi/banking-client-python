...
class GeneralApi(object):
    ...
    def list_ping(self, **kwargs):  # noqa: E501
        """Server heartbeat operation  # noqa: E501

        Publicly available endpoint to answer the question, \"are you there?\"  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.list_ping(async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.list_ping_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.list_ping_with_http_info(**kwargs)  # noqa: E501
            return data

    def list_ping_with_http_info(self, **kwargs):  # noqa: E501
        """Server heartbeat operation  # noqa: E501

        Publicly available endpoint to answer the question, \"are you there?\"  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.list_ping_with_http_info(async=True)
        >>> result = thread.get()
